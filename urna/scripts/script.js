...
function atualizaInterface() {
    ...
    if (candidato.length > 0) {
        ...
        for (let i in candidato.fotos) {
            fotosHtml += `<div class="d-1-image"><img src="./images/${candidato.fotos[i].url}" alt="" width="200">${candidato.fotos[i].legenda}</div>`;
        }
...
function confirma() {
    ...
    else if (numero.length === etapa.numeros + 1) {
        votoConfirmado = true;
        console.log("Confirmando como numero " + numero);
    }
